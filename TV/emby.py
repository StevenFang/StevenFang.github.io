...
class Spider(Spider):
	...
	def getAccessToken(self):
		...
		header = self.header.copy()
		header['Content-Type'] = "application/json; charset=UTF-8"
		r = requests.post(f"{self.baseUrl}/emby/Users/AuthenticateByName", params={"Username": self.username, "Password": self.password , "Pw": self.password , "X-Emby-Client": "Yamby", "X-Emby-Device-Name": "realme-RMX3888", "X-Emby-Device-Id": str(uuid4()), "X-Emby-Client-Version": "1.6.4.5"}, headers=header, timeout=30)
		embyInfos = r.json()
	...
	header = {"User-Agent": "Yamby/1.6.6.18(Android"}
